...
namespace Sales.EndPoint
{
    class Program
    {
        ...
        {
            var endPointName = "Sales.EndPoint";
            ...
            string rabbitmqUrl = Environment.GetEnvironmentVariable("RABBITMQ_FREE_NSB_URL");
            transport.ConnectionString(rabbitmqUrl);

            // Configure persistence
            var persistence = endpointConfiguration.UsePersistence<SqlPersistence>();
            persistence.SqlDialect<SqlDialect.MySql>();
            string mysqlConnectionString = Environment.GetEnvironmentVariable("MYSQL_FREE_NSB_URL");
